...
The optimizations lie in the fact that once you have a max you can skip iterations where sum of the current number of 1s and the number of remaining elements is shorter than that length.
