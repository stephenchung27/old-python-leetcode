...
1. If the house can be placed anywhere where there isn't a store, you can use two pointers from the left and right. Keep a track of all stores that you visit with their indices. 
...
1. If you house can only be placed at the beginning of the block, you can iterate through the entire array until you visited every required store.
2. 
'''
